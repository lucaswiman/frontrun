...
def test_b1_stats_idle_for(max_attempts=500, max_ops=200):
    ...
    with timeout_minutes(5):
        return print_result("stats idle_for", frontrun.explore_random(
...
def test_b2_stats_attempt_number(max_attempts=500, max_ops=200):
    ...
    with timeout_minutes(5):
        return print_result("stats attempt_number", frontrun.explore_random(
...
def test_b3_wrapped_f_stats(max_attempts=500, max_ops=300):
    ...
    with timeout_minutes(5):
        return print_result("wrapped_f.statistics race", frontrun.explore_random(
...
def test_b4_shared_copy_stats(max_attempts=500, max_ops=300):
    ...
    with timeout_minutes(5):
        return print_result("shared copy stats", frontrun.explore_random(
...
def test_b5_idle_for_lost_update(max_attempts=500, max_ops=200):
    ...
    with timeout_minutes(5):
        return print_result("idle_for lost update", frontrun.explore_random(
...
def test_b6_attempt_number_lost_update(max_attempts=500, max_ops=200):
    ...
    with timeout_minutes(5):
        return print_result("attempt_number lost update", frontrun.explore_random(
...
def test_s1_thread_local_stats(max_attempts=20000, max_ops=400):
    ...
    with timeout_minutes(5):
        return print_result("thread_local stats", frontrun.explore_random(
...
def test_s2_per_call_state(max_attempts=20000, max_ops=500):
    ...
    with timeout_minutes(5):
        return print_result("per-call state", frontrun.explore_random(
...
def test_s3_immutable_strategy(max_attempts=20000, max_ops=400):
    ...
    with timeout_minutes(5):
        return print_result("immutable strategy", frontrun.explore_random(
...
def test_s4_copy_isolation(max_attempts=20000, max_ops=500):
    ...
    with timeout_minutes(5):
        return print_result("copy isolation", frontrun.explore_random(
